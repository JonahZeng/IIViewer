    ...
    , openedFile { QString(), QString() }
{
    ...
    connect(ui.exitAction, &QAction::triggered, this, [this]() { this->close(); });
    connect(ui.aboutQtAction, &QAction::triggered, []() { qApp->aboutQt(); });
    connect(ui.aboutThisAction, &QAction::triggered, this, [this]() { AboutDlg dlg(this); dlg.exec(); });
