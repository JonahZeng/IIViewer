...
IIVOptionDialog::IIVOptionDialog(QWidget *parent): QDialog(parent), pix_val_bg_color_index(PaintPixValBgColor::GRAY), ui()
{
    ...
    whiteColorIcon.fill(Qt::GlobalColor::white);
    ...
    grayColorIcon.fill(Qt::GlobalColor::gray);
    ...
    blackColorIcon.fill(Qt::GlobalColor::black);
    ...
    redColorIcon.fill(Qt::GlobalColor::red);
    ...
    yellowColorIcon.fill(Qt::GlobalColor::yellow);
    ...
    greenColorIcon.fill(Qt::GlobalColor::green);
    ...
    cyanColorIcon.fill(Qt::GlobalColor::cyan);
    ...
    blueColorIcon.fill(Qt::GlobalColor::blue);
    ...
    magentaColorIcon.fill(Qt::GlobalColor::magenta);
